...
public class Rangee {
	...
	public boolean ajouterCouleur(Color c) {
		if (this.indiceJeton == 3) {
			this.jetons[this.indiceJeton] = c;
			this.indiceJeton++;
			return true; //Signifie qu'il faut créer une nouvelle rangée
		} else {
			this.jetons[this.indiceJeton] = c;
			this.indiceJeton++;
			return false; //signifie qu'on peur garder cette rangée
		}
	}
